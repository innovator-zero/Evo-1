...
accelerate launch \
    ...
    --disable_swanlab --seed 42 \
    --run_name calvin_stage2 --save_dir checkpoints/evo1_calvin/stage2 \
    --max_steps 80000 \
    --finetune_vlm --resume --resume_pretrain \
    --resume_path checkpoints/evo1_calvin/stage1/step_best \
    "$@"
